...
public class Splash_Activtivity extends AppCompatActivity {
    ...
    public void PermissionCheckUP() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.READ_EXTERNAL_STORAGE},
                    REQUEST_PERMISSION_1);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.CAMERA},
                    REQUEST_PERMISSION_3);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.READ_CONTACTS},
                    REQUEST_PERMISSION_4);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.GET_ACCOUNTS) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.GET_ACCOUNTS},
                    REQUEST_PERMISSION_5);
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
                    REQUEST_PERMISSION_7);
        }
        else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.CALL_PHONE},
        ...
        if (requestCode != REQUEST_PERMISSION_1 && requestCode != REQUEST_PERMISSION_2 && requestCode != REQUEST_PERMISSION_3 && requestCode != REQUEST_PERMISSION_4 && requestCode != REQUEST_PERMISSION_5 && requestCode != REQUEST_PERMISSION_6
            ...
            switch (requestCode) {
                case REQUEST_PERMISSION_1:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                            && ContextCompat.checkSelfPermission(Splash_Activtivity.this, android.Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.READ_PHONE_STATE},
                ...
                case REQUEST_PERMISSION_5:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                            && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION},
                ...
                case REQUEST_PERMISSION_6:
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                            && ContextCompat.checkSelfPermission(Splash_Activtivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(Splash_Activtivity.this, new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION},
                                REQUEST_PERMISSION_7);
                        return;
                    }
                    break;
                ...
                if (getAccountTask.isSuccessful()) {
                    if (securityProfile == null) {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                GoogleSignInAccount acc= GoogleSignIn.getLastSignedInAccount(Splash_Activtivity.this);
                                if(NetworkUtil.isNetworkAvailable(Splash_Activtivity.this))
...
//            },INITIAL_TIME_OUT);
    ...
    public void checkBackup(){
        final Task<DriveFolder> appFolderTask =mDriveResourceClient.getAppFolder();
        appFolderTask.addOnSuccessListener(Splash_Activtivity.this,new OnSuccessListener<DriveFolder>() {
            @Override
            public void onSuccess(DriveFolder driveFolder) {
                Query query = new Query.Builder()
                        .addFilter(Filters.contains(SearchableField.TITLE,"MyAccountsDatabase.db"))
                        .build();

                Task<MetadataBuffer> queryTask = mDriveResourceClient.queryChildren(driveFolder, query);
                queryTask
                        .addOnSuccessListener(Splash_Activtivity.this,
                                new OnSuccessListener<MetadataBuffer>() {
                                    @Override
                                    public void onSuccess(MetadataBuffer metadataBuffer) {
                        ...
                        .addOnFailureListener(Splash_Activtivity.this, new OnFailureListener() {
                            @Override
                            public void onFailure(@NonNull Exception e) {
                                Is_backup_exist=false;
                            }
